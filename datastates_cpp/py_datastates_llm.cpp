...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    py::class_<datastates_llm_t>(m, "handle")
        ...
        .def("restore_tensor", &datastates_llm_t::restore_tensor, py::return_value_policy::take_ownership, py::call_guard<py::gil_scoped_release>())
        .def("alloc_tensor_queue", &datastates_llm_t::alloc_tensor_queue, py::call_guard<py::gil_scoped_release>())
